        ...
        function()
        {
          ...
          var isLessThanIE7 = parseFloat(navigator.appVersion.split('MSIE')[1]) < 7 && document.body.filters, // needed to run the AlphaImageLoader function for IE6
            ...
            setImg =
              function(img, src)
              {
                if (isLessThanIE7 && (src.indexOf('AlphaBar.png'/*tpa=http://painting.nhcilab.com/static/js/jpicker/AlphaBar.png*/) != -1 || src.indexOf('Bars.png'/*tpa=http://painting.nhcilab.com/static/js/jpicker/Bars.png*/) != -1 || src.indexOf('Maps.png'/*tpa=http://painting.nhcilab.com/static/js/jpicker/Maps.png*/) != -1))
                {
                  img.attr('pngSrc', src);
              ...
              function(obj, alpha)
              {
                ...
                if (alpha > 0 && alpha < 100)
                {
                  if (isLessThanIE7)
                  {
                    ...
                    if (src != null && (src.indexOf('AlphaBar.png'/*tpa=http://painting.nhcilab.com/static/js/jpicker/AlphaBar.png*/) != -1 || src.indexOf('Bars.png'/*tpa=http://painting.nhcilab.com/static/js/jpicker/Bars.png*/) != -1 || src.indexOf('Maps.png'/*tpa=http://painting.nhcilab.com/static/js/jpicker/Maps.png*/) != -1))
      ...
      images:
        {
          ...
          colorMap:
          {
            ...
            arrow:
            {
              file: 'mappoint.gif'/*tpa=http://painting.nhcilab.com/static/js/jpicker/mappoint.gif*/, /* ColorMap arrow icon */
              width: 15,
              height: 15
            }
          },
          colorBar:
          {
            ...
            arrow:
            {
              file: 'rangearrows.gif'/*tpa=http://painting.nhcilab.com/static/js/jpicker/rangearrows.gif*/, /* ColorBar arrow icon */
              width: 20,
              height: 7
            }
          },
          picker:
          {
            file: 'picker.gif'/*tpa=http://painting.nhcilab.com/static/js/jpicker/picker.gif*/, /* Color Picker icon */
            width: 25,
            height: 24
          }
        },
